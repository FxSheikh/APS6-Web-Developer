...
-- Question 14
SELECT COUNT(CUSTOMER_NUM) AS NUMBER_OF_CUSTOMERS
FROM CUSTOMER
...
-- Question 17
SELECT MIN(PRICE)AS LEAST_EXPENSIVE_PART
FROM PART;
...
-- Question 19
SELECT REP_NUM,SUM(BALANCE) AS SUM_OF_BALANCES
FROM CUSTOMER
GROUP BY REP_NUM
ORDER BY REP_NUM;
